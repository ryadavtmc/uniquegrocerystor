  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <div class="col-sm-12">
        ...
        <form action="insertpharmacy.php" method="post" enctype="multipart/form-data">
...
?>
    ...
    <div class="col-sm-9">
      <h2 class="center"> <p class="text-center"><button type="button" class="btn btn-dark"><a href="apharmacy.php">Pharmacy</a></button></p></h2>
...
<script>
function myFunction() {
  document.getElementById("demo").innerHTML = "<?= $pharmacy['title']; ?>";
}
</script>
  ...
  <tbody>
    <tr>
      ...
      <td><h4><?= $pharmacy['title']; ?></h4></td>
      <td><h4><?= $pharmacy['product_code']; ?></h4></td>
      <td><p class="price"> New Price: $<?=$pharmacy['price']; ?> </p></td>
      <td> <img src="images/<?= $pharmacy['image'];?>" alt="Image" style="width: 100px; height: 100px"; > </td>
      <td><button type="button" class="btn btn-danger" ><a href="delpharmacy.php?id=<?php echo $pharmacy["id"]; ?>" >Delete</a></button>
    </tr>
