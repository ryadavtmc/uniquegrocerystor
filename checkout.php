...
$ins="INSERT INTO checkout SET id='$id', fullname='$fullname', email='$email', address='$address', city='$city', state='$state', zip='$zip', nameoncard='$nameoncard', creditcardnumber='$creditcardnumber', expmonth='$expmonth', expyear='$expyear', cvv='$cvv'  ";
...
?>
   <h4>Cart <span class="price" style="color:black"><i class="fa fa-shopping-cart"></i> <b><?php echo $count; ?></b></span></h4>
       ...
       <?php
                        ...
                        if(isset($_SESSION['cart']))
                        {
                            foreach($_SESSION['cart'] as $key => $value)
                            {
                               ...
                               $total=$total+$value['price'];
                                ...
                                <p> $value[title] <span class='price' >$ $value[price]</span></p>
                                <p></p>
                        ...
                        ?>
<hr>
 <p>Shipping cost <span class="price" style="color:black"><b>$2.39</b></span></p>
      <p>Total <span class="price" style="color:black"><b>$<?php echo $total+2.39 ?></b></span></p>
      <form action="order.php" method="POST">
       <input type="submit" value="Pay" name="cart" class="btn"></a>
       </form>
