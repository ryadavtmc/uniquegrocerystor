  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <div class="col-sm-12">
        ...
        <form action="insertclothing.php" method="post" enctype="multipart/form-data">
...
<div class="form-group">
    ...
    <div class="col-sm-9">
      <h2 class="center"> <p class="text-center"><button type="button" class="btn btn-dark"><a href="aclothing.php">Clothing</a></button></p></h2>
...
<script>
function myFunction() {
  document.getElementById("demo").innerHTML = "<?= $clothing['title']; ?>";
}
</script>
  ...
  <tbody>
    <tr>
      ...
      <td><h4><?= $clothing['title']; ?></h4></td>
      <td><h4><?= $clothing['product_code']; ?></h4></td>
      <td><p class="price"> New Price: $<?=$clothing['price']; ?> </p></td>
      <td> <img src="images/<?= $clothing['image'];?>" alt="Image" style="width: 100px; height: 100px"; > </td>
      <td><button type="button" class="btn btn-danger" ><a href="delclothing.php?id=<?php echo $clothing["id"]; ?>" >Delete</a></button>
    </tr>
