...
<div>
   ...
   if (isset($_REQUEST['username'])) {
    ...
    if (($password == $cpassword)){
        ...
        $ins="INSERT INTO adminusers SET   fname='$fname', lname='$lname', phonenumber='$phonenumber', username='$username', password='$hash'";
         $result = mysqli_query($conn, $ins); 
        if($result){
            echo "<div class='form'>
                  <h3>You are registered successfully!</h3><br/>
                  <p class='link'>Click here to <a href='adminusers.php'>Login</a></p>
                  </div>";
        } 
        else {
...
<form action="adminsignup.php" style="border:1px solid #ccc">
  <div class="container">
    <h1>Sign Up</h1>
