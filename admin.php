...
?>
    ...
    <div class="col-sm-9">
      <h2 class="center"> <p class="text-center"><button type="button" class="btn btn-dark"><a href="admin.php">Featured Products</a></button></p></h2>
      <div class="container">
...
function myFunction() {
  ...
  <tbody>
    <tr>
      ...
      <td> <img src="images/<?= $products['image'];?>" alt="Image" style="width: 100px; height: 100px"; > </td>
